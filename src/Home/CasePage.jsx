...
const caseDetails = {
  ...
  4: {
    ...
    price: '企业级别，低至¥10000起步（流水线稳定进行 日常，预发，线上 的不同环境搭配）',
                    ...
                    <Row gutter={[20, 20]}>
                      ...
                      <Col xs={24} sm={12}>
                        ...
                        >
                          ...
                          >
                            <li>• 标准运维：支持正常运维内容。数据库容量限制（根据不同业务有变化），每年清理数据</li>
                            <li>• 高级运维：支持动态扩充数据库。数据库容量限制提高（根据不同业务有变化），每两年清理数据</li>
                            <li>• 7x24 小时支持</li>
                          </ul>
                        </div>
                      </Col>
                      ...
                      <Col xs={24} sm={12}>
                        ...
                        >
                          ...
                          >
                            <li>• 根据不同研发周期，我们提供不同的定制价格。对于比较着急的用户。我们提供紧急周期排布。详情联系我们</li>
                          </ul>
                        </div>
                      </Col>
                      {/* 新增项目 */}

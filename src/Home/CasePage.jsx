...
const caseDetails = {
  ...
  2: {
    ...
    features: [
      ...
      '考勤管理： 提供考勤记录、排班安排和请假管理功能，支持自动生成考勤报表，帮助企业更好地管理员工的工作时间。',
      '薪酬管理： 处理薪资计算、工资单生成、税务计算等功能，支持自定义薪资结构和福利设置，确保薪资发放的准确性和合规性。',
      '数据分析： 提供人力资源数据分析和报告，包括员工流动率、考勤统计、薪酬分析等，帮助企业做出数据驱动的决策。',
  ...
  5: {
    ...
    features: [
      ...
      '在线测试与报告： 提供在线测评平台，员工或候选人可以随时进行测试，系统自动生成详细的评估报告，包括个人优势和发展建议。',
